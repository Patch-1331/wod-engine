...
INSERT INTO "new_Exercise" ("altExerciseId", "id", "line", "name", "needsBar", "pattern", "rung", "scalable") SELECT "altExerciseId", "id", "line", "name", "needsBar", "pattern", "rung", "scalable" FROM "Exercise";
DROP TABLE "Exercise";
